...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler vgg_accelerator_dense_layer_Pipeline_VITIS_LOOP_146_3_dense_weights_ROM_AUTO_1R BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename flat_img_V \
    op interface \
    ports { flat_img_V_address0 { O 10 vector } flat_img_V_ce0 { O 1 bit } flat_img_V_q0 { I 8 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    id 1406 \
    name output_packet_last_V \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_output_packet_last_V \
    op interface \
    ports { output_packet_last_V { I 1 vector } } \
} "
}
