...
set C_modelArgList {
	...
	{ s_input int 8 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "INPUT_STREAM_V_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "s_input", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ s_input_din sc_out sc_lv 8 signal 4 } 
	{ s_input_num_data_valid sc_in sc_lv 8 signal 4 } 
	{ s_input_fifo_cap sc_in sc_lv 8 signal 4 } 
	{ s_input_full_n sc_in sc_logic 1 signal 4 } 
	{ s_input_write sc_out sc_logic 1 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "s_input_din", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "s_input", "role": "din" }} , 
 	...
 	{ "name": "s_input_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "s_input", "role": "full_n" }} , 
 	{ "name": "s_input_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "s_input", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		...
		"Port" : [
			...
			{"Name" : "s_input", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "128", "DependentChanType" : "0",
				"BlockSignal" : [
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_INPUT_STREAM_V_last_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	s_input { ap_fifo {  { s_input_din fifo_port_we 1 8 }  { s_input_num_data_valid fifo_status_num_data_valid 0 8 }  { s_input_fifo_cap fifo_update 0 8 }  { s_input_full_n fifo_status 0 1 }  { s_input_write fifo_data 1 1 } } }
}
