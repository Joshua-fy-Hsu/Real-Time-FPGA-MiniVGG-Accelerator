...
HD_PWD='D:/University/Junior/HLS/VGG_Accelerator/rtl/vgg_accelerator.runs/design_1_vgg_accelerator_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_vgg_accelerator_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_vgg_accelerator_0_0.tcl
